    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href='<?=\yii\helpers\Html::img('@web/images/preview_l1.jpg')?>' class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: <?php \yii\helpers\Html::img('@web/'.$item->path);?>,largeimage: 'images/preview_l1.jpg'}"><img src="<?php \yii\helpers\Html::img('@web/'.$item->path);?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <?php
                            //获取品牌
                            $brand = \backend\models\Brand::findOne(['id'=>$goods->brand_id]);
                            ?>
                    ...
                    <div class="desc mt10">
                        ...
                        <?php
                        $intro = \backend\models\GoodsIntro::findOne(['goods_id'=>$goods->id])
                        ?>
                        <?=$intro->intro;?>
                    </div>
                </div>
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/user2.gif')?></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/user3.gif')?></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
