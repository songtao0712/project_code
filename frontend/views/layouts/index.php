...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to('/list/search')?>" name="serarch" method="post" class="fl">
                    <input type="text" class="txt" name="search" value="请输入商品关键字" /><input type="submit" class="btn" value="搜索" />
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <?=\frontend\widgets\GoodsCategory::widget()?>
