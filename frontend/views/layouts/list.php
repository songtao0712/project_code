...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><?=Html::img('@web/images/logo.png',['alt'=>'京东商城'])?></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
                ...
                <dd>
                    <div class="prompt">
                        <?php if(Yii::$app->user->isGuest){
                            echo '[您好，请'.Html::a('登录',['user/login']).']';
                        }else{
                            echo Html::a('注销'.'<b>'.Yii::$app->user->identity->username.'</b>',['user/logout']);
                        };?>
                    </div>
