    ...
    <div class="login_bd">
        <div class="login_form fl">
            ...
            <ul>
                        ...
                        <?=$form->field($model,'code',['options'=>['class'=>'checkcode']])->widget(\yii\captcha\Captcha::className(),['template'=>'{input}{image}']);?>

                        <?=$form->field($model,'remember')->checkbox(['class'=>'box-check']);?>
